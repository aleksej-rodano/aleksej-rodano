...
- **[Plant Experiments App](https://github.com/aleksej-rodano/plant-experiments-app)** — Full-stack TypeScript app ([live demo](https://plant-experiments-app.vercel.app)).

## Tech

Python (NumPy, SciPy, pandas, scikit-learn) · Jupyter · TypeScript · numerical methods & simulation
